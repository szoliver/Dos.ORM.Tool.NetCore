...
namespace Dos.Tools
{
    public class EntityBuilder
    {
        ...
        [Obsolete("由于没有Dotnet Core稳定版本的RazorEngine可用，调用无参构造函数将按最新定义的模板手动生成实体定义代码")]
        ...
        public string Builder()
        {
            ...
            /* var result =Razor.Parse(tplContent, new{}); */  //已过时，弃用！！！
    ...
    public class DbToCS
    {
        ...
        /// 类型配置文件
        /// </summary>
        public static readonly string DbTypePath = AppContext.BaseDirectory + "/Config/dbtype.xml";
