...
namespace Dos.Tools
{
    public class Utils
    {
        ...
        /// 数据库连接配置文件
        /// </summary>
        public static readonly string DatabaseconfigPath = AppContext.BaseDirectory + "/Config/databaseconfig.xml";
...
", Encoding.UTF8);
        ...
        /// 系统配置路径
        /// </summary>
        public static string SysconfigPath = AppContext.BaseDirectory + "/Config/sysconfig.xml";
